...
//import liuzl.pojo.{AppOperationBean, _}
...
//      val applicationDurationBean = AppUsageDurationBean(employee_id,package_name,app_name,use_duration,wifi_flow,mobile_flow,install_count,tenant_id,collect_date,create_time)
//
//      // 获取当前时间
//      getTime()
//
