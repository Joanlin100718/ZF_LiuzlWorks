...
object Spark_KafkaTOMySQL_STAT {
...
//    val tp =  TopicAndPartition("AIOPS_ETE_SERVSTATTOPO" , 0)
//    val test =  Map[TopicAndPartition, Long](tp-> 320000 )
...
//    val kafkaSource: InputDStream[(String, Int, Long , String)] = KafkaUtils.createDirectStream[String, String, StringDecoder, StringDecoder, (String, Int , Long , String)](ssc, kafkaParams, test , messageHandler);
